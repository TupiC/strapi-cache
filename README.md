...
'strapi-cache': {
  ...
  config: {
    ...
    cacheGetTimeoutInMs: 1000, // Timeout for getting cached data in milliseconds (default is 1 second, redis only)
...
| `cacheGetTimeoutInMs`     | Max time to wait for a cache read before treating it as a miss (redis only)                                                                                                                                                                                                                                                                            | Milliseconds (default: `1000`)                                                                                                |
